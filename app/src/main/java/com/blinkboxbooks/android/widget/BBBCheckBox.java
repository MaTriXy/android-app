...
/**
 * Custom CheckBox class which simplifies setting a custom font. Font is set via custom view attributes
 */
public class BBBCheckBox extends CheckBox {

    public BBBCheckBox(Context context) {
        super(context);
    }

    public BBBCheckBox(Context context, AttributeSet attrs, int defStyle) {
    ...
    public BBBCheckBox(Context context, AttributeSet attrs) {
        super(context, attrs);
