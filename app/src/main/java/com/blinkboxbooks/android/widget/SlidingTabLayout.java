...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private SparseArray<TextView> mTabTitles = new SparseArray<TextView>();

    private ViewPager mViewPager;
    private ViewPager.OnPageChangeListener mViewPagerPageChangeListener;

    private boolean mTabsEqualWeight;
    ...
    /**
     * If set each tab will have the same layout weight (and therefore be all the same width)
     * @param tabsEqualsWeight
     */
    public void setTabsEqualsWeight(boolean tabsEqualsWeight) {
        mTabsEqualWeight = tabsEqualsWeight;
    }
    ...
    /**
     * Override the default text that is displayed as the title for a particular page at the specified index
     * @param pageIndex the page index to set the title for
     * @param text the title text to set
     */
    public void setCustomTabText(int pageIndex, String text) {

        TextView tabText = mTabTitles.get(pageIndex);
    ...
    private void resetTabSelectedState() {
        final int tabStripChildCount = mTabStrip.getChildCount();
