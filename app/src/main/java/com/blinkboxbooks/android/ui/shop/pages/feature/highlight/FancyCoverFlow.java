...
public class FancyCoverFlow extends Gallery {
    ...
    private static final String TAG = FancyCoverFlow.class.getSimpleName();
    ...
    /**
     * Listener to implement single tap behaviour
     */
    private FancyCoverFlow.OnSingleTapListener listener;
    ...
    protected boolean getChildStaticTransformation(View child, Transformation t) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 16) {
            ...
            // This code causes constant updating, but is unfortunatley required in order to display correctly on 16+
            // The suggested fix from: https://github.com/davidschreiber/FancyCoverFlow/issues/15
            // does not work for our case. Resolving this will be a complex task so we will live with it for now....
            item.invalidate();
        }
    ...
    public void setListener(FancyCoverFlow.OnSingleTapListener listener) {
